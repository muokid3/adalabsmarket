            ...
            if (_id !== '') {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        // set the update url
                        var action =  '/admin/user_groups/update';
                                    ...
                                    @foreach($user_groups as $user_group)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <form action="{{ url('admin/user_groups/delete') }}" method="post" style="display: inline;" class="delete-model-form">
                                                    {{ csrf_field() }}
                                                    <input type="hidden" name="id" value="{{$user_group->id}}">
                                                    <button class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</button>
                                                </form>
                                                <a href="{{ url('admin/users/groups/'.$user_group->id) }}" class="btn btn-sm btn-link bg-success">
...
{{--                    <h4 class="modal-title" id="myModalLabel"> {{ $edit ?'Edit' : 'Add' }} Role</h4>--}}
                ...
                <div class="modal-body" >
                    ...
                    <form action="{{ url('admin/user_groups') }}"  method="post" id="group-form">
                        {{ csrf_field() }}
